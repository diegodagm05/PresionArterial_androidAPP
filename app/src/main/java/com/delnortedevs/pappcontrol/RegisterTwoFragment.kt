...
import com.delnortedevs.pappcontrol.databinding.FragmentRegisterBinding
import com.delnortedevs.pappcontrol.databinding.FragmentRegisterTwoBinding
...
class RegisterTwoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnFinishRegister.setOnClickListener{
            findNavController().navigate(R.id.action_registerTwoFragment_to_homePatientFragment)
        }
        return binding.root
    }
